...
// Unity LauncherEntry protocol, supported by Plasma and other shells for
// taskbar icon badges and progress bars
...
// emits directly on the calling thread so it still goes out during shutdown
